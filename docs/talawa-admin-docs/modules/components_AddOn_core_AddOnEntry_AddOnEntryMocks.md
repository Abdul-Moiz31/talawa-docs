...
[src/components/AddOn/core/AddOnEntry/AddOnEntryMocks.ts:13](https://github.com/adi790uu/talawa-admin/blob/cdaad16/src/components/AddOn/core/AddOnEntry/AddOnEntryMocks.ts#L13)
