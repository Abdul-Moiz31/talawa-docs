...
\<p\>TalwaPluginProvider provides ability to implement features as plugins\</p\>
...
##### [build](../plugins_talawa_plugin_provider/TalawaPluginProvider/build.md)([BuildContext](https:api.flutter.dev/flutter/widgets/BuildContext-class.html) context) [Widget](https:api.flutter.dev/flutter/widgets/Widget-class.html)



build the Plugin combining local \<code\>visibility\</code\> property and \<code\>serverVisible\</code\> property  
...
return \<code\>bool\</code\> decides the final visibility of the verifying from database and current OrgId  
