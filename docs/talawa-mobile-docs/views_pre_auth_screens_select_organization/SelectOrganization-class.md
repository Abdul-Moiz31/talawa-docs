...
\<p\>This widget lets the user select new organizations.\</p\>
\<p\>There is a list tile which displays the organization selected by the user.
He/she needs to press the "continue" button to proceed.\</p\>
