...
\<p\>ChatTile return a widget for a tile in the list of Direct Chats in the Chat List Screen.\</p\>
...
##### [build](../views_after_auth_screens_chat_direct_chats/ChatTile/build.md)([BuildContext](https:api.flutter.dev/flutter/widgets/BuildContext-class.html) context) [Widget](https:api.flutter.dev/flutter/widgets/Widget-class.html)
