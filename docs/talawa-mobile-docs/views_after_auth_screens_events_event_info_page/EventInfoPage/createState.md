...
_EventInfoPageState createState
()
...
later inserted into the tree again, the framework will call \<a href="../../views_after_auth_screens_events_event_info_page/EventInfoPage/createState.md"\>createState\</a\>
