...
\<p\>Shows the list of events with options to categorize them.\</p\>
...
##### [homeModel](../views_after_auth_screens_events_explore_events/ExploreEvents/homeModel.md) &#8594; [MainScreenViewModel](../view_model_main_screen_view_model/MainScreenViewModel-class.md)?
...
##### [build](../views_after_auth_screens_events_explore_events/ExploreEvents/build.md)([BuildContext](https:api.flutter.dev/flutter/widgets/BuildContext-class.html) context) [Widget](https:api.flutter.dev/flutter/widgets/Widget-class.html)
