...
\<p\>SelectContact returns a widget that has mutable state _SelectContactState.\</p\>
...
[SelectContact](../views_after_auth_screens_chat_select_contact/SelectContact/SelectContact.md) (\{[Key](https:api.flutter.dev/flutter/foundation/Key-class.html)? key\})
...
##### [createState](../views_after_auth_screens_chat_select_contact/SelectContact/createState.md)() _SelectContactState
