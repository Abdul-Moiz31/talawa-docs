...
##### [getPostsById](../utils_post_queries/PostQueries/getPostsById.md)([String](https:api.flutter.dev/flutter/dart-core/String-class.html) orgId) [String](https:api.flutter.dev/flutter/dart-core/String-class.html)
