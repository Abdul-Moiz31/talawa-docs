...
\<p\>AppSettingsPage is a widget that has mutable state _AppSettingsPageState.\</p\>
...
[AppSettingsPage](../views_after_auth_screens_app_settings_app_settings_page/AppSettingsPage/AppSettingsPage.md) (\{[Key](https:api.flutter.dev/flutter/foundation/Key-class.html)? key\})
...
##### [createState](../views_after_auth_screens_app_settings_app_settings_page/AppSettingsPage/createState.md)() _AppSettingsPageState
