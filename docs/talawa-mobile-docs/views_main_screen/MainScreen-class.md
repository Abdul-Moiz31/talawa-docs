...
[MainScreen](../views_main_screen/MainScreen/MainScreen.md) (\{[Key](https:api.flutter.dev/flutter/foundation/Key-class.html)? key, required [MainScreenArgs](../models_mainscreen_navigation_args/MainScreenArgs-class.md) mainScreenArgs\})
