...
\<p\>This widget lets a user sign in/up with the organization url.\</p\>
\<p\>The user can enter an organization through the QR code scanner,
...
At the bottom, there is also a gesture detector for changing the language.\</p\>
