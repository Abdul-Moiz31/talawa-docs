...
\<p\>ChatMessageScreen returns a StatelessWidget for showing the chat message screen.\</p\>
...
##### [build](../views_after_auth_screens_chat_chat_message_screen/ChatMessageScreen/build.md)([BuildContext](https:api.flutter.dev/flutter/widgets/BuildContext-class.html) context) [Widget](https:api.flutter.dev/flutter/widgets/Widget-class.html)
