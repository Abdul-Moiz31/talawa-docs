...
\<p\>CreateEventPage returns a widget that has mutable state _CreateEventPageState.\</p\>
...
[CreateEventPage](../views_after_auth_screens_events_create_event_page/CreateEventPage/CreateEventPage.md) (\{[Key](https:api.flutter.dev/flutter/foundation/Key-class.html)? key\})
...
##### [createState](../views_after_auth_screens_events_create_event_page/CreateEventPage/createState.md)() _CreateEventPageState
