...
[src/libraries/errors/unauthorizedError.ts:6](https://github.com/PalisadoesFoundation/talawa-api/blob/9fa6a1c/src/libraries/errors/unauthorizedError.ts#L6)
