...
[src/resolvers/MembershipRequest/organization.ts:10](https://github.com/PalisadoesFoundation/talawa-api/blob/9fa6a1c/src/resolvers/MembershipRequest/organization.ts#L10)
