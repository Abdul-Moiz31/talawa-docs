...
[src/helpers/event/updateEventHelpers/updateRecurringEvent.ts:24](https://github.com/PalisadoesFoundation/talawa-api/blob/9fa6a1c/src/helpers/event/updateEventHelpers/updateRecurringEvent.ts#L24)
