...
[src/services/OrganizationCache/cacheOrganizations.ts:6](https://github.com/PalisadoesFoundation/talawa-api/blob/9fa6a1c/src/services/OrganizationCache/cacheOrganizations.ts#L6)
