...
[src/resolvers/GroupChatMessage/groupChatMessageBelongsTo.ts:10](https://github.com/PalisadoesFoundation/talawa-api/blob/9fa6a1c/src/resolvers/GroupChatMessage/groupChatMessageBelongsTo.ts#L10)
