...
[src/resolvers/Mutation/createSampleOrganization.ts:19](https://github.com/PalisadoesFoundation/talawa-api/blob/9fa6a1c/src/resolvers/Mutation/createSampleOrganization.ts#L19)
