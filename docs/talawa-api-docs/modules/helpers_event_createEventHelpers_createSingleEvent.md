...
[src/helpers/event/createEventHelpers/createSingleEvent.ts:19](https://github.com/PalisadoesFoundation/talawa-api/blob/9fa6a1c/src/helpers/event/createEventHelpers/createSingleEvent.ts#L19)
