...
[src/services/CommentCache/deleteCommentFromCache.ts:4](https://github.com/PalisadoesFoundation/talawa-api/blob/9fa6a1c/src/services/CommentCache/deleteCommentFromCache.ts#L4)
